...
exports[`lib/test.mjs TAP \`errorHandler\` middleware handles an error after \`ctx.response.body\` was set. > Response body. 1`] = `
...
exports[`lib/test.mjs TAP \`execute\` middleware option \`override\` returning not an object. > Response body. 1`] = `
{"errors":[{"message":"Internal Server Error"}]}
`

exports[`lib/test.mjs TAP \`execute\` middleware option \`override\` returning options invalid. > Response body. 1`] = `
{"errors":[{"message":"Internal Server Error"}]}
`
